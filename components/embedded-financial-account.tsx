...
interface EmbeddedFinancialAccountProps {
  connectedAccountId: string
  financialAccountId: string
}

export function EmbeddedFinancialAccount({
  connectedAccountId,
  financialAccountId,
}: EmbeddedFinancialAccountProps) {
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="rounded-lg border border-red-200 bg-red-50 p-4">
          <p className="text-red-800">Error loading financial account: {error}</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-muted-foreground">Loading financial account...</p>
        </div>
      </div>
    )
  }
